...
export default function Milstone(props) {
  const { theme } = props;
  let aamdevfl = useRef(null);
  let hkcc = useRef(null);
  let polyu = useRef(null);
  let aamdev = useRef(null);
  let pricedev = useRef(null);
  let priceSeniorDev = useRef(null);
  ...
  const [MilestoneItems, setMilestoneItems] = useState([
    ...
    {
      type: 'career',
      link: 'price-developer',
      title: 'Web Developer - Price.com.hk',
      date: '2020 - 2021',
      ref: pricedev,
      isActive: true,
    },
    {
      type: 'career',
      link: 'price-senior-developer',
      title: 'Senior Web Developer - Price.com.hk',
      date: '2021 - 20222',
      ref: priceSeniorDev,
      isActive: true,
    },
    ...
    <>
      <section id="milestone" className="milestone-section">
        ...
        <div className="codetag-cta" ref={milestone}>
          ...
          />
          <div className="section-header">Milestone</div>
          <img
